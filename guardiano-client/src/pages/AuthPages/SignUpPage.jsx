...
const SignUpPage = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://66.media.tumblr.com/7e54b7fc1b241d9bc709050bf64929ab/tumblr_mtisvo5e4Q1sjooyeo1_1280.png')",
      }}
    >
      <div className="bg-white/85 backdrop-blur-md rounded-2xl shadow-lg p-10 max-w-lg w-full">
